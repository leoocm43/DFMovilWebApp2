...
class ParticularsControllerTest < ActionController::TestCase
  ...
  test "should create particular" do
    assert_difference('Particular.count') do
      post :create, particular: { infracciones: @particular.infracciones, placa: @particular.placa, tenencia: @particular.tenencia, verificaciones: @particular.verificaciones }
    end
  ...
  test "should update particular" do
    patch :update, id: @particular, particular: { infracciones: @particular.infracciones, placa: @particular.placa, tenencia: @particular.tenencia, verificaciones: @particular.verificaciones }
    assert_redirected_to particular_path(assigns(:particular))
  end
